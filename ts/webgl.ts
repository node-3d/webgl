...
export type TWebGL = TNativeTrimmed &
	Readonly<TWebGLOverrides> &
	Readonly<TWebGLConstructors> &
	TWebGLState;

// Public immutable API surface
export const webgl = native as unknown as TWebGL;

const wrapF32 = (v: TArrayValue): ArrayBufferView =>
	v.constructor === Float32Array ? v : new Float32Array(v);
const wrapI32 = (v: TArrayValue): ArrayBufferView =>
	v.constructor === Int32Array ? v : new Int32Array(v);
const wrapUi32 = (v: TArrayValue): ArrayBufferView =>
	v.constructor === Uint32Array ? v : new Uint32Array(v);
...
if (!gl.__isInited) {
	...
	global.WebGLRenderingContext =
		gl.WebGLRenderingContext as unknown as typeof WebGLRenderingContext;
	...
	global.WebGLVertexArrayObject =
		gl.WebGLVertexArrayObject as unknown as typeof WebGLVertexArrayObject;
	...
	global.WebGLTransformFeedback =
		gl.WebGLTransformFeedback as unknown as typeof WebGLTransformFeedback;

	gl._versionString = 'WebGL 1.0';
	gl.useWebGL2 = () => {
		global.WebGL2RenderingContext =
			gl.WebGL2RenderingContext as unknown as typeof WebGL2RenderingContext;
	...
	gl.getActiveAttrib = (program: WebGLProgram, idx: number) =>
		new gl.WebGLActiveInfo(_getActiveAttrib(program as WebGLProgramImpl, idx));
	...
	gl.bufferSubData = (target, offset, v: TArrayValue) =>
		_bufferSubData(target, offset, wrapF32(v));
	...
	gl.uniform1fv = (location, v: TArrayValue) =>
		_uniform1fv(location as WebGLUniformLocationImpl, wrapF32(v));

	const _uniform1iv = native.uniform1iv;
	gl.uniform1iv = (location, v: TArrayValue) =>
		_uniform1iv(location as WebGLUniformLocationImpl, wrapI32(v));

	const _uniform2fv = native.uniform2fv;
	gl.uniform2fv = (location, v: TArrayValue) =>
		_uniform2fv(location as WebGLUniformLocationImpl, wrapF32(v));

	const _uniform2iv = native.uniform2iv;
	gl.uniform2iv = (location, v: TArrayValue) =>
		_uniform2iv(location as WebGLUniformLocationImpl, wrapI32(v));

	const _uniform3fv = native.uniform3fv;
	gl.uniform3fv = (location, v: TArrayValue) =>
		_uniform3fv(location as WebGLUniformLocationImpl, wrapF32(v));

	const _uniform3iv = native.uniform3iv;
	gl.uniform3iv = (location, v: TArrayValue) =>
		_uniform3iv(location as WebGLUniformLocationImpl, wrapI32(v));

	const _uniform4fv = native.uniform4fv;
	gl.uniform4fv = (location, v: TArrayValue) =>
		_uniform4fv(location as WebGLUniformLocationImpl, wrapF32(v));

	const _uniform4iv = native.uniform4iv;
	gl.uniform4iv = (location, v: TArrayValue) =>
		_uniform4iv(location as WebGLUniformLocationImpl, wrapI32(v));

	const _uniformMatrix2fv = native.uniformMatrix2fv;
	gl.uniformMatrix2fv = (location, isT, v: TArrayValue) =>
		_uniformMatrix2fv(location as WebGLUniformLocationImpl, isT, wrapF32(v));

	const _uniformMatrix3fv = native.uniformMatrix3fv;
	gl.uniformMatrix3fv = (location, isT, v: TArrayValue) =>
		_uniformMatrix3fv(location as WebGLUniformLocationImpl, isT, wrapF32(v));

	const _uniformMatrix4fv = native.uniformMatrix4fv;
	gl.uniformMatrix4fv = (location, isT, v: TArrayValue) =>
		_uniformMatrix4fv(location as WebGLUniformLocationImpl, isT, wrapF32(v));

	const _uniform1uiv = native.uniform1uiv;
	gl.uniform1uiv = (location, v: TArrayValue) =>
		_uniform1uiv(location as WebGLUniformLocationImpl, wrapUi32(v));

	const _uniform2uiv = native.uniform2uiv;
	gl.uniform2uiv = (location, v: TArrayValue) =>
		_uniform2uiv(location as WebGLUniformLocationImpl, wrapUi32(v));

	const _uniform3uiv = native.uniform3uiv;
	gl.uniform3uiv = (location, v: TArrayValue) =>
		_uniform3uiv(location as WebGLUniformLocationImpl, wrapUi32(v));

	const _uniform4uiv = native.uniform4uiv;
	gl.uniform4uiv = (location, v: TArrayValue) =>
		_uniform4uiv(location as WebGLUniformLocationImpl, wrapUi32(v));

	const _uniformMatrix2x3fv = native.uniformMatrix2x3fv;
	gl.uniformMatrix2x3fv = (location, isT, v: TArrayValue) =>
		_uniformMatrix2x3fv(location as WebGLUniformLocationImpl, isT, wrapF32(v));

	const _uniformMatrix2x4fv = native.uniformMatrix2x4fv;
	gl.uniformMatrix2x4fv = (location, isT, v: TArrayValue) =>
		_uniformMatrix2x4fv(location as WebGLUniformLocationImpl, isT, wrapF32(v));

	const _uniformMatrix3x2fv = native.uniformMatrix3x2fv;
	gl.uniformMatrix3x2fv = (location, isT, v: TArrayValue) =>
		_uniformMatrix3x2fv(location as WebGLUniformLocationImpl, isT, wrapF32(v));

	const _uniformMatrix3x4fv = native.uniformMatrix3x4fv;
	gl.uniformMatrix3x4fv = (location, isT, v: TArrayValue) =>
		_uniformMatrix3x4fv(location as WebGLUniformLocationImpl, isT, wrapF32(v));

	const _uniformMatrix4x2fv = native.uniformMatrix4x2fv;
	gl.uniformMatrix4x2fv = (location, isT, v: TArrayValue) =>
		_uniformMatrix4x2fv(location as WebGLUniformLocationImpl, isT, wrapF32(v));

	const _uniformMatrix4x3fv = native.uniformMatrix4x3fv;
	gl.uniformMatrix4x3fv = (location, isT, v: TArrayValue) =>
		_uniformMatrix4x3fv(location as WebGLUniformLocationImpl, isT, wrapF32(v));
	...
	gl.clientWaitSync = (sync, flags, timeout) =>
		_clientWaitSync(extractSync(sync), flags, timeout);
	...
	gl.getParameter = (pname) => {
		...
		if (pname === gl.COPY_READ_BUFFER_BINDING || pname === gl.COPY_WRITE_BUFFER_BINDING) {
			return null;
		}
