...
#define CASES_PARAM_INT4                                                                                     \
	case GL_SCISSOR_BOX:                                                                                     \
	case GL_VIEWPORT:

#define CASES_PARAM_FLOAT2                                                                                   \
	case GL_ALIASED_LINE_WIDTH_RANGE:                                                                        \
	case GL_ALIASED_POINT_SIZE_RANGE:                                                                        \
	case GL_DEPTH_RANGE:

#define CASES_PARAM_FLOAT4                                                                                   \
	case GL_BLEND_COLOR:                                                                                     \
	case GL_COLOR_CLEAR_VALUE:

#define CASES_PARAM_BOOL4 case GL_COLOR_WRITEMASK:

#define CASES_PARAM_INT                                                                                      \
