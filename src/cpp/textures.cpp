...
DBG_EXPORT JS_METHOD(compressedTexSubImage2D) {
	...
	glCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, size, pixels);
...
DBG_EXPORT JS_METHOD(compressedTexImage3D) {
	...
	glCompressedTexImage3D(target, level, internalformat, width, height, depth, border, size, pixels);
